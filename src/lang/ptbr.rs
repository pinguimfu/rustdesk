...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Verification code", "Codigo de verificação"),
        ("verification_tip", ""),
        ("Logout", "Sair"),
        ("Tags", "Tags"),
        ...
        ("Right click to select tabs", "Clique com o botão direito para selecionar abas"),
        ("Skipped", "Pulado"),
        ("Add to Address Book", "Adicionar a catalogo de endereços"),
        ("Group", "Grupo"),
        ("Search", "Pesquisar"),
        ...
        ("Ask the remote user for authentication", "Pergunte ao usuario remoto para autenticar"),
        ("Choose this if the remote account is administrator", "Escolha isto se a conta remota é administrador"),
        ("Transmit the username and password of administrator", ""),
        ("still_click_uac_tip", ""),
        ("Request Elevation", "Requisitar Elevação"),
        ("wait_accept_uac_tip", ""),
        ...
        ("Please confirm if you want to share your desktop?", "Por favor confirme que você deseja compartilhar este desktop"),
        ("Display", "Tela"),
        ("Default View Style", "Forma de visualização padrão"),
